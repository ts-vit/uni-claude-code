...
updated: 2026-05-18T06:57:42Z
---

## Current Test

[all tests passed by user 2026-05-18]
...
(none — все 5 сценариев пройдены пользователем 2026-05-18; «Привет» → ~53k токенов на первом сообщении — это нормально для Claude Code CLI, см. отдельное обсуждение ниже)
